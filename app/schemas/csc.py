...
from app.schemas.oauth2 import CredentialCreationRequest
...
class CredentialKey:
    ...
    @classmethod
    def from_json(cls, data: dict) -> "CredentialKey":
        if not data:
            return None
...
class CredentialCert:
    ...
    @classmethod
    def from_json(cls, data: dict) -> "CredentialCert":
        if not data:
            return None
...
class CredentialAuth:
    ...
    @classmethod
    def from_json(cls, data: dict) -> "CredentialAuth":
        if not data:
            return None
        try:
            return cls(
...
class CredentialsListResponse:
    ...
    def from_json(cls, data: dict) -> "CredentialsListResponse":
        return cls(
            ...
            credential_infos=[CredentialInfo.from_json(info) for info in data["credentialInfos"]] if data.get("credentialInfos") else None,
        )
...
class CredentialCertInfoResponse:
    ...
    @classmethod
    def from_json(cls, data: dict) -> "CredentialCertInfoResponse":
        if not data:
            return None
        try:
            return cls(
